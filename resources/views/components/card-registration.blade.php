<div class="card card-custom p-0 mb-3">
    ...
    @if ($status != 'refund')
        <div class="border-top p-3">
            <button type="button" class="btn btn-outline-primary py-2" data-bs-target="#show{{ $status }}{{ $registration->id }}" data-bs-toggle="modal">
                <i class="bi bi-eye me-1"></i>Details
            </button>
            <button type="button" class="btn btn-primary py-2" data-bs-toggle="modal" data-bs-target="#destroy{{ $registration->id }}">
