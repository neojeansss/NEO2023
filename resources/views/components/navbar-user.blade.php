        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end p-1 border-0 shadow-sm rounded-3 px-4 py-3" style="font-size: 14px">
                <div class="d-flex align-items-center">
                    <span class="pe-2" style="color: #FF5A01 !important"><i class="bi bi-person-circle fs-3"></i></span>
                ...
                <li>
                     <a class="dropdown-item ps-2 pe-3 py-1 rounded-3" href="{{ route('dashboard') }}"><span class="col-3"><i class="pe-2 bi bi-grid-1x2-fill" style="color: #FF5A01 !important"></i></span> {{ __('Dashboard') }}</a>
                </li>
                <li>
                     <a class="dropdown-item ps-2 pe-3 py-1 rounded-3" href="{{ route('registrations.index') }}"><span class="col-3"><i class="pe-2 bi bi-clipboard-data-fill" style="color: #FF5A01 !important"></i></span> {{ __('My Registrations') }}</a>
                </li>
                <hr class="my-1">
                <li>
