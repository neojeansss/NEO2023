    ...
    <div class="container-fluid px-5">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end p-1 border-0 shadow-sm rounded-3 px-4 py-3" style="font-size: 14px">
                ...
                <hr class="my-1">
                <li>
                     <a class="dropdown-item px-2 py-1 rounded-3" href="{{ route('home') }}"><span class="col-3"><i class="pe-2 fa-solid fa-house" style="color: #FF5A01 !important"></i></span> {{ __('Home') }}</a>
                </li>
                <li>
                     <a class="dropdown-item px-2 py-1 rounded-3" href="{{ route('dashboard') }}"><span class="col-3"><i class="pe-2 bi bi-grid-1x2-fill" style="color: #FF5A01 !important"></i></span> {{ __('Dashboard') }}</a>
                </li>
                <hr class="my-1">
                <li>
