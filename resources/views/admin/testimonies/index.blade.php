<x-app title="Testimonies | NEO 2022">
      ...
      <div class="container p-5">
          <div class="d-flex justify-content-between align-items-center mb-4">
              ...
              <a type="button" href="{{ route('testimonies.create') }}" class="btn btn-primary">
              ...
              <div class="card-body">
                                  ...
                                  <tr>
                                      <td class="align-middle">
                                          <div class="row gx-3 my-3">
                                              <div class="col-3">
                                                  <img src="/storage/images/testimonies/{{ $testimony->picture }}"
                                      ...
                                      <td class="align-middle">{{ $testimony->message }}</td>
                                      <td class="align-middle">
                  ...
                  @else
                      <div class="text-center">
                          <img src="/storage/images/assets/empty.svg" alt="No testimony Yet" width="20%">
