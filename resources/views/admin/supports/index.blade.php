<x-app title="Supports | NEO 2022">
    ...
    <div class="container p-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a type="button" href="{{ route('supports.create') }}" class="btn btn-primary">
            ...
            <div class="card-body">
                ...
                @else
                    <div class="text-center">
                        <img src="/storage/images/assets/empty.svg" alt="No Support Yet" width="20%">
