                    ...
                    <div id="subCategory" class="row mb-3 d-none">
                        ...
                        <div class="col">
                            <fieldset>
                                ...
                                <input type="radio" class="btn-check" id="storytelling" name="sub_category"
                                    value="storytelling" disabled>
                                <label for="storytelling" class="btn btn-selection rounded-pill">Storytelling</label>

                                <input type="radio" class="btn-check" id="speech" name="sub_category" value="speech" disabled>
