<x-app title="Access Control | NEO 2023 Dashboard Admin">
      ...
      <div class="container p-5">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a type="button" href="{{ route('access-controls.create') }}" class="btn btn-primary">
                    <i class="fa-solid fa-plus me-2"></i>Add Access Control
                </a>
            </div>
                  ...
                  <div class="card-body">
                      ...
                      @else
                          <div class="text-center">
                              <img src="/storage/images/assets/empty.svg" alt="No Access Control Yet" width="20%">
