<x-app title="Add Judge | NEO 2022">
      ...
      <div class="container p-5" style="max-width: 60rem">
          <h4 class="mb-4 fw-semibold text-primary">Edit Judge</h4>
  
          <form method="POST" action="{{ route('judges.update',$judge) }}" enctype="multipart/form-data">
              @csrf
              <div class="card card-custom mb-3">
                  <div class="card-body">
                      ...
                      <div class="row mb-3">
                          ...
                          <div class="col">
                              <input type="text" class="form-control" name="role" required value="{{ $judge->role }}">
                          </div>
                      </div>
                      ...
                      <div class="row">
                          ...
                          <div class="col">
                              <textarea class="form-control" name="message" rows="3" required value="{{ $judge->message }}">{{ $judge->message }}</textarea>
                          </div>
                      </div>
